...
assistant=AssistantAgent("help assist",llm_config={"config_list":config_list})
assistant=AssistantAgent("patient_info_collect",llm_config={"config_list":config_list},description="Collect the patient deatils and store it in the database",tool=patient_info ) # tool or func
assistant=AssistantAgent("check_available_doctors",llm_config={"config_list":config_list})
assistant=AssistantAgent("book_appointment",llm_config={"config_list":config_list})
...
1. Compulsory Ask the user for their details like please tell Name, Age, Email, and Phone Number.
